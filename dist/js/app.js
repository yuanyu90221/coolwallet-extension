  ...
  _createClass(App, [{
    ...
    value: function componentDidMount() {
      ...
      if (typeof web3 !== 'undefined') {
        ...
        console.log(Web3);
        var provider = new Web3.providers.HttpProvider('http://10.0.0.123:8540');
        var _web = new Web3(provider);
        console.log('else loop');
        console.log(provider);
        this.setState({ web3: _web, provider: provider });
      }
    }
  }, {
    key: 'loadAccounts',
    ...
    value: function renderAccounts() {
      ...
      return accounts.map(function (account, index) {
        return _react2.default.createElement(_QRcode2.default, { id: 'canvas' + index, key: index, text: account });
      });
    }
  }, {
    key: 'render',
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        isLogin && _react2.default.createElement(
          'button',
          { onClick: this.loadAccounts.bind(this) },
          'Load accounts'
        ),
...
var QRcode = function (_Component) {
  ...
  _createClass(QRcode, [{
    key: "toggleQRcode",
    value: function toggleQRcode(text) {
      var _state = this.state,
          id = _state.id,
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        !isShow && _react2.default.createElement(
          "div",
          { onClick: this.toggleQRcode.bind(this, text) },
          text
        )
      );
    }
...
if(false) {
	module.hot.accept("!!../../node_modules/css-loader/index.js?modules&importLoaders=1&localIdentName=[name]__[local]___[hash:base64:5]!../../node_modules/postcss-loader/lib/index.js??ref--2-2!./Login.css", function() {
		var newContent = require("!!../../node_modules/css-loader/index.js?modules&importLoaders=1&localIdentName=[name]__[local]___[hash:base64:5]!../../node_modules/postcss-loader/lib/index.js??ref--2-2!./Login.css");
